...
## Summary
- 407 nodes · 559 edges · 23 communities (20 shown, 3 thin omitted)
...
- `Reports()` --calls--> `formatDuration()`  [EXTRACTED]
  client/src/pages/Reports.jsx → client/src/utils/constants.js
- `AppLayout()` --calls--> `useAuth()`  [EXTRACTED]
  client/src/App.jsx → client/src/context/AuthContext.jsx
- `DataIntegration()` --calls--> `useAuth()`  [EXTRACTED]
  client/src/pages/DataIntegration.jsx → client/src/context/AuthContext.jsx
- `DataIntegration()` --calls--> `formatDuration()`  [EXTRACTED]
  client/src/pages/DataIntegration.jsx → client/src/utils/constants.js
...
### Community 0 - "App.jsx"
Cohesion: 0.10
Nodes (39): App(), AppLayout(), Footer(), Header(), ProtectedRoute(), ICONS, Sidebar(), CORRIDOR_SEGMENTS (+31 more)

### Community 1 - "scheduleController.js"
Cohesion: 0.07
...
### Community 2 - "middleware/auth.js"
Cohesion: 0.07
Nodes (28): jwt, protect(), requireRole(), User, authController, express, { protect }, router (+20 more)

### Community 3 - "dependencies"
Cohesion: 0.06
Nodes (34): bcryptjs, jspdf-autotable, cors, dotenv, express, express-validator, jsonwebtoken, jspdf-autotable (+26 more)

### Community 4 - "dependencies"
Cohesion: 0.06
Nodes (33): axios, dependencies, axios, @fullcalendar/core, @fullcalendar/daygrid, @fullcalendar/interaction, @fullcalendar/react, @fullcalendar/resource-timeline (+25 more)

### Community 5 - "reportController.js"
Cohesion: 0.07
Nodes (13): AuditLog, BlockSchedule, { CorridorBlock }, exportReport(), formatDuration(), MaintenanceTask, XLSX, AuditLog (+5 more)
...
### Community 7 - "seedData.js"
Cohesion: 0.08
Nodes (18): mongoose, AuditLog, { body, validationResult }, jwt, User, auditLogSchema, mongoose, bcrypt (+10 more)
...
### Community 9 - "🚆 AI-Powered Automatic Block Planning System — Indian Railways"
Cohesion: 0.10
...
### Community 10 - "PrioritizationEngine"
Cohesion: 0.15
...
Cohesion: 0.21
Nodes (11): { Sequelize }, testConnection(), app, connectMongo, cors, dotenv, express, morgan (+3 more)

### Community 13 - "server/package.json"
Cohesion: 0.17
...
## Knowledge Gaps
- **179 isolated node(s):** `api`, `ICONS`, `CORRIDOR_SEGMENTS`, `STATIONS`, `AuthContext` (+174 more)
...
- **Why does `dependencies` connect `dependencies` to `client/package.json`, `dependencies`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `server/package.json`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `jspdf-autotable` connect `dependencies` to `dependencies`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **What connects `api`, `ICONS`, `CORRIDOR_SEGMENTS` to the rest of the system?**
  _179 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `App.jsx` be split into smaller, more focused modules?**
  _Cohesion score 0.10025062656641603 - nodes in this community are weakly interconnected._
- **Should `scheduleController.js` be split into smaller, more focused modules?**
